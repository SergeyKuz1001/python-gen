...
from additional_nodes import ModuleInnerVersion
...
from tree_depth_checker import TreeDepthChecker
...
def main(seed: int, args: list[str]) -> tuple[str, Generator]:
    c: Config = {
        "module": Constructor(
            ModuleInnerVersion,
        ...
        "parameters": LambdaConst(Parameters),
    ...
    g = Generator(seed, c, cs)
    return (GenNode("module").visit(g).code, g)


if __name__ == "__main__":
    print(main(int(sys.argv[1]), sys.argv[2:])[0])
